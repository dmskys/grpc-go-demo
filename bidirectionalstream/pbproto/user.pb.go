...
type UserInfoServiceClient interface {
	// 微服务中获取用户信息的 RPC 函数
	// stream 关键字表示此函数将发送数据流
	GetUserInfo(ctx context.Context, opts ...grpc.CallOption) (UserInfoService_GetUserInfoClient, error)
}
...
func (c *userInfoServiceClient) GetUserInfo(ctx context.Context, opts ...grpc.CallOption) (UserInfoService_GetUserInfoClient, error) {
...
func (x *userInfoServiceGetUserInfoClient) Send(m *UserRequest) error {
...
type UserInfoServiceServer interface {
	// 微服务中获取用户信息的 RPC 函数
	// stream 关键字表示此函数将发送数据流
	GetUserInfo(UserInfoService_GetUserInfoServer) error
}
...
func _UserInfoService_GetUserInfo_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserInfoServiceServer).GetUserInfo(&userInfoServiceGetUserInfoServer{stream})
}
...
func (x *userInfoServiceGetUserInfoServer) Recv() (*UserRequest, error) {
	m := new(UserRequest)
...
var fileDescriptor0 = []byte{
	...
	0xd6, 0x92, 0xcc, 0x92, 0x9c, 0x54, 0x09, 0x16, 0x05, 0x66, 0x0d, 0xce, 0x20, 0x08, 0xc7, 0x28,
	0x90, 0x8b, 0x1f, 0x64, 0xb6, 0x67, 0x5e, 0x5a, 0x7e, 0x70, 0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa,
	0x90, 0x1d, 0x17, 0xb7, 0x7b, 0x6a, 0x09, 0x4c, 0x54, 0x48, 0x44, 0x0f, 0xea, 0x50, 0x3d, 0x24,
	0x57, 0x4a, 0x89, 0xa2, 0x89, 0x42, 0x9c, 0xa6, 0xc1, 0x68, 0xc0, 0x98, 0xc4, 0x06, 0x16, 0x37,
	0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x3e, 0x63, 0xe7, 0x1a, 0xed, 0x00, 0x00, 0x00,
}
